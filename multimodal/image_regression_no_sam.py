...
bottom_20_percent_index = int(len(df_train) * benign_perc)
...
def train(df):
    ...
    model.load_state_dict(torch.load("models/image_regression_123_0.2_benign_validated_lr_0.0002_64_vcreg_4170172_b_64_dp_0.1.bin"))
    ...
    PATH = f"image_regression_{pred_dim}_{benign_perc}_benign_validated_lr_{CONFIG['learning_rate']}_{CONFIG['img_size']}_vcreg_{params}_b_{CONFIG['train_batch_size']}_dp_{CONFIG['dropout']}"
    ...
    for epoch in range(1, CONFIG['epochs'] + 1):
        ...
        for batch_idx, data in enumerate(train_loader):
            ...
            running_loss_vcreg += mae_batch.item()
            iters += 1
