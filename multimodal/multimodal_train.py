...
def train(df):
    ...
    for fold in range(folds):
        ...
        model = Multimodal_Soft_GLUMLP(hidden_dim=104 + 120, output_dim=1).cuda()
        print(
        ...
        PATH = f"images_{CONFIG['img_size']}_early_concat_conf_loss_vcreg_softmax_glu_{params}_b_{CONFIG['train_batch_size']}_dp_{CONFIG['dropout']}_fold_{fold}"
